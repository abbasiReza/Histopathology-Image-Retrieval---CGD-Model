...
def process_isc_data(data_path):
    ...
    for index, line in enumerate(open('D:\\in shop\\list_eval_partition.txt', 'r', encoding='utf-8')):
        if index > 1:
